...
final Color darkPrimaryColor = Color(0xff1C658C);
final Color darkSecondaryColor = Color(0xFF398AB9);//work as secondary color
...
final Color addCoinColor = Color(0xFF398AB9);
final Color hurryUpTimerColor = Color(0xff1C658C);//timer color when 25% time left
